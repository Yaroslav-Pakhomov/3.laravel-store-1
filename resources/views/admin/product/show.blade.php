...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        @endphp
        <img src="{{ $product->full_image ?? 'https://via.placeholder.com/600x250' }}" alt="" class="img-fluid">
    </div>
</div>
<div class="row">
    <div class="col-12">
        ...
        <form method="post" class="d-inline" onsubmit="return confirm('Удалить этот товар?')" action="{{ route('admin.product.delete', [$product->id]) }}">
            @csrf
            @method('DELETE')
